...
**[breast-cancer](https://github.com/porgerkriswin/breast-cancer)**
A machine learning project for breast cancer prediction/classification using patient data.
`Tech: Python`

**[meditrack.1](https://github.com/porgerkriswin/meditrack.1)**
A medication/health tracking application to help manage and monitor medicine schedules.
`Tech: [add tech used]`

**[retail_inventory](https://github.com/porgerkriswin/retail_inventory)**
A retail inventory management system to track stock, sales, and product records.
`Tech: [add tech used]`

**[Crewof1](https://github.com/JOSEMICHAELRAJ/Crewof1)**
